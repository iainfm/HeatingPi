...
For external switch control, wire a suitable SPST latching switch between GPIO 17 (Pin 11) and [3.3V | GND] with (optionall) a ~470R resistor in series to prevent accidental current-related issues.
